...
def front_x(words):
    # +++ SUA SOLUÇÃO +++
    lista_01 = [palavra for palavra in words]
    lista_02 = [palavra for palavra in words if palavra[0] == 'x']
    return sorted(lista_02) + sorted([palavra for palavra in lista_01 if palavra[0] != 'x' ])
